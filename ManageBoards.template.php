...
function template_modify_category()
{
	...
	echo '
						...
						<dd>
							<input id="acilirkapanir" type="checkbox" name="collapse"', $context['category']['can_collapse'] ? ' checked="checked"' : '', ' tabindex="', $context['tabindex']++, '" class="input_check" /><label for="acilirkapanir"></label>
						</dd>';
...
function template_modify_board()
{
	...
	foreach ($context['groups'] as $group)
		echo '
								...
								<input type="checkbox" name="groups[]" value="', $group['id'], '" id="groups_', $group['id'], '"', $group['checked'] ? ' checked="checked"' : '', ' class="input_check" /><label for="groups_', $group['id'], '">
	...
	echo '
							<em>', $txt['check_all'], '</em> <input id="input_grupp_hepsi" type="checkbox" class="input_check" onclick="invertAll(this, this.form, \'groups[]\');" /><label for="input_grupp_hepsi"></for><br />
							<br />
						</dd>';
	...
	if (empty($context['board']['is_recycle']) && empty($context['board']['topics']))
		echo '
					<dl class="settings">
						...
						<dd>
							<input type="checkbox" id="redirect_enable" name="redirect_enable"', $context['board']['topics'] ? ' disabled="disabled"' : '', $context['board']['redirect'] != '' ? ' checked="checked"' : '', ' onclick="refreshOptions();" class="input_check" /><label for="redirect_enable"></label>
						</dd>
					</dl>';
			...
			echo '
					<div id="reset_redirect_div">
						<dl class="settings">
							...
							<dd>
								<input id="input_yonlendir" type="checkbox" name="reset_redirect" class="input_check" /><label for="input_yonlendir"></label>
	...
	echo '
					<div id="count_posts_div">
						<dl class="settings">
							...
							<dd>
								<input id="input_check_count" type="checkbox" name="count" ', $context['board']['count_posts'] ? ' checked="checked"' : '', ' class="input_check" /><label for="input_check_count"></label>
							</dd>
						</dl>
					</div>';
