...
function template_admin()
{
	...
	echo '
		<script type="text/javascript" src="', $settings['theme_url'], '/scripts/admin.js?fin20"></script>
...
function template_edit_censored()
{
	...
	echo '
					...
					<dl class="settings">
						<dt>
							<strong>', $txt['censor_whole_words'], ':</strong>
						</dt>
						<dd>
							<input type="checkbox" name="censorWholeWord" value="1" id="censorWholeWord_check"', empty($modSettings['censorWholeWord']) ? '' : ' checked="checked"', ' class="input_check" /><label for="censorWholeWord_check"></label>
						</dd>
						<dt>
							<strong>', $txt['censor_case'], ':</strong>
						</dt>
						<dd>
							<input type="checkbox" name="censorIgnoreCase" value="1" id="censorIgnoreCase_check"', empty($modSettings['censorIgnoreCase']) ? '' : ' checked="checked"', ' class="input_check" /><label for="censorIgnoreCase_check"></label>
						</dd>
					</dl>
		...
		if (is_array($config_var))
		{
			...
			else
			{
				...
				if ($config_var['type'] == 'check')
				{
					...
					echo '
							<input type="checkbox"', $javascript, $disabled, ' name="', $config_var['name'], '" id="', $config_var['name'], '"', ($config_var['value'] ? ' checked="checked"' : ''), ' value="1" class="input_check" /><label for="', $config_var['name'], '"></label>';
				}
				...
				<div class="content">
					<fieldset>
						...
						<dl class="settings">
							...
							<dd>
								<input type="checkbox" name="display" id="display"', $context['field']['display'] ? ' checked="checked"' : '', ' class="input_check" /><label for="display"></label>
							</dd>
					...
					<fieldset>
						...
						<dl class="settings">
							...
							<dd id="bbc_dd">
								<input id="input_bbc" type="checkbox" name="bbc"', $context['field']['bbc'] ? ' checked="checked"' : '', ' class="input_check" /><label for="input_bbc"></label>
							</dd>
							<dt id="options_dt">
	...
	echo '
					...
					<fieldset>
						...
						<dl class="settings">
							...
							<dd id="can_search_dd">
								<input id="input_aranabilir" type="checkbox" name="can_search"', $context['field']['can_search'] ? ' checked="checked"' : '', ' class="input_check" /><label for="input_aranabilir"></label>
							</dd>
							<dt>
							...
							<dd>
								<input id="input_aktif" type="checkbox" name="active"', $context['field']['active'] ? ' checked="checked"' : '', ' class="input_check" /><label for="input_aktif"></label>
							</dd>
						</dl>
					</fieldset>
					<div class="righttext">
