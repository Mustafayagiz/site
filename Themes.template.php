...
function template_main()
{
				...
				<div class="content">
					<dl class="settings">
						...
						<dd>
							...
							<label for="options-theme_allow"></label>
						</dd>
						<dt>
	...
	foreach ($context['themes'] as $theme)
		echo '
								<input type="checkbox" name="options[known_themes][]" id="options-known_themes_', $theme['id'], '" value="', $theme['id'], '"', $theme['known'] ? ' checked="checked"' : '', ' class="input_check" /><label for="options-known_themes_', $theme['id'], '">', $theme['name'], '</label><br />';
	...
	foreach ($context['options'] as $setting)
	{
		...
		if ($setting['type'] == 'checkbox')
		{
			echo '
							...
							<input type="checkbox" name="', !empty($setting['default']) ? 'default_' : '', 'options[', $setting['id'], ']" id="options_', $setting['id'], '"', !empty($setting['value']) ? ' checked="checked"' : '', $context['theme_options_reset'] ? ' disabled="disabled"' : '', ' value="1" class="input_check" /><label for="options_', $setting['id'], '">', $setting['label'], '</label>';
		}
	...
	foreach ($context['settings'] as $setting)
	{
		...
		elseif ($setting['type'] == 'checkbox')
		{
			...
			echo '
						...
						<dd>
							<input type="hidden" name="', !empty($setting['default']) ? 'default_' : '', 'options[', $setting['id'], ']" value="0" />
							<input type="checkbox" name="', !empty($setting['default']) ? 'default_' : '', 'options[', $setting['id'], ']" id="', $setting['id'], '"', !empty($setting['value']) ? ' checked="checked"' : '', ' value="1" class="input_check" /><label for="', $setting['id'], '"></label>
						</dd>';
		}
		// A list with options?
		elseif ($setting['type'] == 'list')
