			...
			<div class="windowbg2">
				...
				<fieldset class="content">
					<dl class="register_form">
						...
						<dd>
							<input type="checkbox" name="allow_email" id="allow_email" tabindex="', $context['tabindex']++, '" class="input_check" /><label for="allow_email"></label>
						</dd>
					</dl>';
...
function template_admin_register()
{
	...
	echo '
					<dt>
						<strong>', $txt['admin_register_email_detail'], ':</strong>
						<span class="smalltext">', $txt['admin_register_email_detail_desc'], '</span>
					</dt>
					<dd>
						<input type="checkbox" name="emailPassword" id="emailPassword_check" tabindex="', $context['tabindex']++, '" checked="checked" disabled="disabled" class="input_check" /><label for="emailPassword_check"></label>
					</dd>
					<dt>
						<strong>', $txt['admin_register_email_activate'], ':</strong>
					</dt>
					<dd>
						<input type="checkbox" name="emailActivate" id="emailActivate_check" tabindex="', $context['tabindex']++, '"', !empty($modSettings['registration_method']) && $modSettings['registration_method'] == 1 ? ' checked="checked"' : '', ' onclick="onCheckChange();" class="input_check" /><label for="emailActivate_check"></label>
					</dd>
				</dl>
				<div class="righttext">
					<input type="submit" name="regSubmit" value="', $txt['register'], '" tabindex="', $context['tabindex']++, '" class="button_submit" />
...
function template_edit_agreement()
{
	...
	echo '
					...
					<p>
						<input type="checkbox" name="requireAgreement" id="requireAgreement"', $context['require_agreement'] ? ' checked="checked"' : '', ' tabindex="', $context['tabindex']++, '" value="1" class="input_check" /><label for="requireAgreement">', $txt['admin_agreement'], '.</label>
					</p>
					<div class="righttext">
	...
	echo '
		...
		<form id="registration_agreement" class="windowbg2" action="', $scripturl, '?action=admin;area=regcenter" method="post" accept-charset="', $context['character_set'], '">
			...
			<div class="content">
				...
				<ul class="reset">
					<li><input type="checkbox" name="matchword" id="matchword" tabindex="', $context['tabindex']++, '" ', $context['reserved_word_options']['match_word'] ? 'checked="checked"' : '', ' class="input_check" /><label for="matchword">', $txt['admin_match_whole'], '</label></li>
					<li><input type="checkbox" name="matchcase" id="matchcase" tabindex="', $context['tabindex']++, '" ', $context['reserved_word_options']['match_case'] ? 'checked="checked"' : '', ' class="input_check" /><label for="matchcase">', $txt['admin_match_case'], '</label></li>
					<li><input type="checkbox" name="matchuser" id="matchuser" tabindex="', $context['tabindex']++, '" ', $context['reserved_word_options']['match_user'] ? 'checked="checked"' : '', ' class="input_check" /><label for="matchuser">', $txt['admin_check_user'], '</label></li>
					<li><input type="checkbox" name="matchname" id="matchname" tabindex="', $context['tabindex']++, '" ', $context['reserved_word_options']['match_name'] ? 'checked="checked"' : '', ' class="input_check" /><label for="matchname">', $txt['admin_check_display'], '</label></li>
				</ul>
				<div class="righttext">
