...
function template_profile_above()
{
	...
	echo '
	<script type="text/javascript" src="', $settings['theme_url'], '/scripts/profile.js"></script>';
...
function template_summary()
{
	...
	<div class="cat_bar">
		<h3 class="catbg">
			<span class="ie6_header floatleft"><i style="color: white;" class="fas fa-user-alt"></i>', $txt['summary'], '</span>
		</h3>
	</div>
	<div id="profilbirlestir">
	<div id="basicinfo">
		<div class="windowbg">
	...
	if ($context['member']['website']['url'] !== '' && !isset($context['disabled_fields']['website']))
		echo '<li><a href="', $context['member']['website']['url'], '" title="' . $context['member']['website']['title'] . '" target="_blank" class="new_win">', ($settings['use_image_buttons'] ? '<img src="' . $settings['images_url'] . '/www_sm.gif" alt="' . $context['member']['website']['title'] . '" />' : $txt['www']), '</a></li>';
	...
	{
		echo '<img src="', $settings['images_url'], '/avatar.png"/><br/>';
	}
	else
		echo '', $context['member']['avatar']['image'], '';
	if($context['member']['online']['is_online'])
		echo '<font size="4" color="', $context['member']['group_color'],'">', $context['member']['name'], '</font><div id="profilcevrimici" class="cevrimicidurum"></div>';
	else
		echo '<font size="4" color="', $context['member']['group_color'],'">', $context['member']['name'], '</font><div id="profilcevrimdisi" class="cevrimicidurum"></div>';

	echo '<br/>', (!empty($context['member']['group']) ? $context['member']['group'] : $context['member']['post_group']), '';
	echo '<br/><br/>';
...
function template_showPosts()
{
	...
	if (!isset($context['attachments']))
	{
		...
		<div class="topic">
			...
			if ($post['can_reply'])
				echo '
						<li class="reply_button"><a href="', $scripturl, '?action=post;topic=', $post['topic'], '.', $post['start'], '"><i title="', $txt['reply'],'" class="fas fa-reply"></i></a></li>';

			// If they *can* quote?
			if ($post['can_quote'])
				echo '
						<li class="quote_button"><a href="', $scripturl . '?action=post;topic=', $post['topic'], '.', $post['start'], ';quote=', $post['id'], '"><i title="Alıntıla" class="fas fa-quote-left"></i></a></li>';

			// Can we request notification of topics?
			if ($post['can_mark_notify'])
				echo '<li class="notify_button"><a href="', $scripturl, '?action=notify;topic=', $post['topic'], '.', $post['start'], '"><i title="', $txt['notify'],'" class="fas fa-bell"></i></a></li>';

			// How about... even... remove it entirely?!
			if ($post['can_delete'])
				echo '
						<li class="remove_button"><a href="', $scripturl, '?action=deletemsg;msg=', $post['id'], ';topic=', $post['topic'], ';profile;u=', $context['member']['id'], ';start=', $context['start'], ';', $context['session_var'], '=', $context['session_id'], '" onclick="return confirm(\'', $txt['remove_message'], '?\');"><i title="Sil" class="fas fa-trash-alt"></i></a></li>';
...
function template_editBuddies()
{
	...
	<script type="text/javascript" src="', $settings['theme_url'], '/scripts/suggest.js?fin20"></script>
	<script type="text/javascript"><!-- // --><![CDATA[
	...
	foreach ($context['profile_fields'] as $key => $field)
	{
		...
		else
		{
			...
			elseif ($field['type'] == 'check')
				echo '
							<input type="hidden" name="', $key, '" value="0" /><input type="checkbox" name="', $key, '" id="', $key, '" ', !empty($field['value']) ? ' checked="checked"' : '', ' value="1" class="input_check" ', $field['input_attr'], ' /><label for="', $key, '"></label>';
...
function template_profile_pm_settings()
{
	...
	echo '
								...
								<dd>
										...
										<input type="checkbox" name="default_options[view_newest_pm_first]" id="view_newest_pm_first" value="1"', !empty($context['member']['options']['view_newest_pm_first']) ? ' checked="checked"' : '', ' class="input_check" /><label for="view_newest_pm_first"></label>
								</dd>
						</dl>
						<hr />
						<dl>
	...
	echo '
								...
								<dd>
										...
										<input type="checkbox" name="default_options[popup_messages]" id="popup_messages" value="1"', !empty($context['member']['options']['popup_messages']) ? ' checked="checked"' : '', ' class="input_check" /><label for="popup_messages"></label>
								</dd>
						</dl>
						<hr />
						<dl>
								...
								<dd>
										...
										<input type="checkbox" name="default_options[copy_to_outbox]" id="copy_to_outbox" value="1"', !empty($context['member']['options']['copy_to_outbox']) ? ' checked="checked"' : '', ' class="input_check" /><label for="copy_to_outbox"></label>
								</dd>
								<dt>
								...
								<dd>
										...
										<input type="checkbox" name="default_options[pm_remove_inbox_label]" id="pm_remove_inbox_label" value="1"', !empty($context['member']['options']['pm_remove_inbox_label']) ? ' checked="checked"' : '', ' class="input_check" /><label for="pm_remove_inbox_label"></label>
								</dd>';
	...
	echo '
						...
						<ul id="theme_settings">
							<li>
								...
								', $txt['board_desc_inside'], ' <input type="checkbox" name="default_options[show_board_desc]" id="show_board_desc" value="1"', !empty($context['member']['options']['show_board_desc']) ? ' checked="checked"' : '', ' class="input_check" />232<label for="show_board_desc"> </label>
							</li>
							<li>
								<input type="hidden" name="default_options[show_children]" value="0" />
								', $txt['show_children'], ' <input type="checkbox" name="default_options[show_children]" id="show_children" value="1"', !empty($context['member']['options']['show_children']) ? ' checked="checked"' : '', ' class="input_check" /><label for="show_children"></label>
							</li>
							<li>
								<input type="hidden" name="default_options[show_no_avatars]" value="0" />
								', $txt['show_no_avatars'], ' <input type="checkbox" name="default_options[show_no_avatars]" id="show_no_avatars" value="1"', !empty($context['member']['options']['show_no_avatars']) ? ' checked="checked"' : '', ' class="input_check" /><label for="show_no_avatars"></label>
							</li>
							<li>
								<input type="hidden" name="default_options[show_no_signatures]" value="0" />
								', $txt['show_no_signatures'], ' <input type="checkbox" name="default_options[show_no_signatures]" id="show_no_signatures" value="1"', !empty($context['member']['options']['show_no_signatures']) ? ' checked="checked"' : '', ' class="input_check" /><label for="show_no_signatures"></label>
							</li>';
	...
	if ($settings['allow_no_censored'])
		echo '
							<li>
								...
								' . $txt['show_no_censored'] . ' <input type="checkbox" name="default_options[show_no_censored]" id="show_no_censored" value="1"' . (!empty($context['member']['options']['show_no_censored']) ? ' checked="checked"' : '') . ' class="input_check" /><label for="show_no_censored"></label>
							</li>';

	echo '
							<li>
								<input type="hidden" name="default_options[return_to_post]" value="0" />
								', $txt['return_to_post'], ' <input type="checkbox" name="default_options[return_to_post]" id="return_to_post" value="1"', !empty($context['member']['options']['return_to_post']) ? ' checked="checked"' : '', ' class="input_check" /><label for="return_to_post"></label>
							</li>
							<li>
								<input type="hidden" name="default_options[no_new_reply_warning]" value="0" />
								', $txt['no_new_reply_warning'], ' <input type="checkbox" name="default_options[no_new_reply_warning]" id="no_new_reply_warning" value="1"', !empty($context['member']['options']['no_new_reply_warning']) ? ' checked="checked"' : '', ' class="input_check" /><label for="no_new_reply_warning"></label>
							</li>';
	...
	if (!empty($modSettings['enable_buddylist']))
		echo '
							<li>
								...
								', $txt['posts_apply_ignore_list'], ' <input type="checkbox" name="default_options[posts_apply_ignore_list]" id="posts_apply_ignore_list" value="1"', !empty($context['member']['options']['posts_apply_ignore_list']) ? ' checked="checked"' : '', ' class="input_check" /><label for="posts_apply_ignore_list"></label>
							</li>';

	echo '
							<li>
								<input type="hidden" name="default_options[view_newest_first]" value="0" />
								', $txt['recent_posts_at_top'], ' <input type="checkbox" name="default_options[view_newest_first]" id="view_newest_first" value="1"', !empty($context['member']['options']['view_newest_first']) ? ' checked="checked"' : '', ' class="input_check" /><label for="view_newest_first"></label>
							</li>';
	...
	if (empty($modSettings['disable_wysiwyg']))
		echo '
							<li>
								...
								', $txt['wysiwyg_default'], ' <input type="checkbox" name="default_options[wysiwyg_default]" id="wysiwyg_default" value="1"', !empty($context['member']['options']['wysiwyg_default']) ? ' checked="checked"' : '', ' class="input_check" /><label for="wysiwyg_default"></label>
							</li>';
		...
		echo '
							...
							<dd>
								<span id="additional_groupsList">
									<input id="additional_groups" type="hidden" name="additional_groups[]" value="0" />';
		// For each membergroup show a checkbox so members can be assigned to more than one group.
		foreach ($context['member_groups'] as $member_group)
			if ($member_group['can_be_additional'])
				echo '<input type="checkbox" name="additional_groups[]" value="', $member_group['id'], '" id="additional_groups-', $member_group['id'], '"', $member_group['is_additional'] ? ' checked="checked"' : '', ' class="input_check" /> <label for="additional_groups-', $member_group['id'], '">', $member_group['name'], '</label><br />';
		echo '
								</span>
...
function template_profile_birthdate()
{
	...
	echo '
							...
							<dd>
								<input style="width: 60px;" type="text" name="bday3" size="4" maxlength="4" value="', $context['member']['birth_date']['year'], '" class="input_text" /> -
								<input style="width: 45px;" type="text" name="bday1" size="2" maxlength="2" value="', $context['member']['birth_date']['month'], '" class="input_text" /> -
								<input style="width: 45px;" type="text" name="bday2" size="2" maxlength="2" value="', $context['member']['birth_date']['day'], '" class="input_text" />
							</dd>';
}
...
function template_profile_signature_modify()
{
	...
	if ($context['show_spellchecking'])
		echo '
								<script type="text/javascript" src="', $settings['theme_url'], '/scripts/spellcheck.js"></script>';
