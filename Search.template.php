...
function template_main()
{
	...
	else
	{
		...
		echo '
				<dl id="search_options">
					...
					<dd class="options">
						', $txt['search_show_complete_messages'], ' <input type="checkbox" name="show_complete" id="show_complete" value="1"', !empty($context['search_params']['show_complete']) ? ' checked="checked"' : '', ' class="input_check" /><label for="show_complete"></label><br />
						', $txt['search_subject_only'], ' <input type="checkbox" name="subject_only" id="subject_only" value="1"', !empty($context['search_params']['subject_only']) ? ' checked="checked"' : '', ' class="input_check" /><label for="subject_only"></label>
					</dd>
	...
	foreach ($context['categories'] as $category)
	{
		...
		foreach ($category['boards'] as $board)
		{
			...
			echo '
								<li class="board">
									', $board['name'], ' <input type="checkbox" id="brd', $board['id'], '" name="brd[', $board['id'], ']" value="', $board['id'], '"', $board['selected'] ? ' checked="checked"' : '', ' class="input_check" /><label for="brd', $board['id'], '" style="margin-', $context['right_to_left'] ? 'right' : 'left', ': ', $board['child_level'], 'em;"></label>
								</li>';
		...
		<div class="cat_bar">
			<h3 class="catbg">
				<span class="floatright">';
					if (!empty($options['display_quick_mod']) && $options['display_quick_mod'] == 1)
					echo '
							<input id="input_checkk" type="checkbox" onclick="invertAll(this, this.form, \'topics[]\');" class="input_check" /><label for="input_checkk"></label>';
				echo '
				</span>
		...
		while ($topic = $context['get_topics']())
		{
			...
			foreach ($topic['matches'] as $message)
			{
				...
				if (!empty($options['display_quick_mod']))
				{
					...
					{
						echo '<input id="input_check_', $topic['id'], '" type="checkbox" name="topics[]" value="', $topic['id'], '" class="input_check" />
							<label for="input_check_', $topic['id'], '"></label>';
					}
					else
					{
