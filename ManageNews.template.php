			...
			<table class="table_grid" width="100%">
				<thead>
					<tr class="catbg">
						...
						<th class="last_th" align="center" width="5%"><input id="input_checkboxid" type="checkbox" class="input_check" onclick="invertAll(this, this.form);" /><label for="input_checkboxid"></label></th>
					</tr>
				</thead>
				<tbody>';
		...
		echo '
					<tr class="windowbg2">
						<td align="center">
							...
							<input id="input_checkbox_', $admin_news['id'], '" type="checkbox" name="remove[]" value="', $admin_news['id'], '" class="input_check" /><label for="input_checkbox_', $admin_news['id'], '"></label>
						</td>
					</tr>';
...
function template_email_members()
{
	...
	foreach ($context['groups'] as $group)
				echo '
							<input type="checkbox" name="groups[', $group['id'], ']" id="groups_', $group['id'], '" value="', $group['id'], '" checked="checked" class="input_check" />
							<label for="groups_', $group['id'], '">', $group['name'], '</label> <em>(', $group['member_count'], ')</em><br />';

	echo '
							<br />
							<input type="checkbox" id="checkAllGroups" checked="checked" onclick="invertAll(this, this.form, \'groups\');" class="input_check" />
							<label for="checkAllGroups"><em>', $txt['check_all'], '</em></label>';
