...
function template_login()
{
	...
	echo '
		<script type="text/javascript" src="', $settings['theme_url'], '/scripts/sha1.js"></script>
	...
	echo '
				<dl>
					...
					<dd><input id="input_check" type="checkbox" name="cookieneverexp"', $context['never_expire'] ? ' checked="checked"' : '', ' class="input_check" onclick="this.form.cookielength.disabled = this.checked;" /><label for="input_check"></label></dd>';
	// If they have deleted their account, give them a chance to change their mind.
	if (isset($context['login_show_undelete']))
		echo '
					<dt class="alert">', $txt['undelete_account'], ':</dt>
					<dd><input id="input_check" type="checkbox" name="undelete" class="input_check" /><label for="input_check"></label></dd>';
	echo '
				</dl>
...
function template_kick_guest()
{
	...
	echo '
					...
					<dt>', $txt['always_logged_in'], ':</dt>
					<dd><input id="input_check" type="checkbox" name="cookieneverexp" class="input_check" onclick="this.form.cookielength.disabled = this.checked;" /><label for="input_check"></label></dd>
				</dl>
	...
	<div class="tborder login" id="maintenance_mode">
		...
		<div class="roundframe">
			<dl>
				...
				<dd><input type="text" name="cookielength" size="4" maxlength="4" value="', $modSettings['cookieTime'], '" class="input_text" /></dd>
				<dt>', $txt['always_logged_in'], ':</dt>
				<dd><input id="input_check" type="checkbox" name="cookieneverexp" class="input_check" /><label for="input_check"></label></dd>
			</dl>
			<p class="centertext"><input type="submit" value="', $txt['login'], '" class="button_submit" /></p>
		</div>
		<span class="lowerframe"><span></span></span>
