		...
		<form action="', $scripturl, '?action=admin;area=viewmembers" method="post" accept-charset="', $context['character_set'], '">
					...
					<div class="flow_hidden">
						<div class="msearch_details floatleft">
							<fieldset>
								...
								<input type="checkbox" name="gender[]" value="0" id="gender-0" checked="checked" class="input_check" /><label for="gender-0">', $txt['undefined_gender'], '</label>&nbsp;&nbsp;
								<input type="checkbox" name="gender[]" value="1" id="gender-1" checked="checked" class="input_check" /><label for="gender-1">', $txt['male'], '</label>&nbsp;&nbsp;
								<input type="checkbox" name="gender[]" value="2" id="gender-2" checked="checked" class="input_check" /><label for="gender-2">', $txt['female'], '</label>
							</fieldset>
						</div>
						<div class="msearch_details floatright">
							<fieldset>
								<legend>', $txt['activation_status'], '</legend>
								<input type="checkbox" name="activated[]" value="1" id="activated-0" checked="checked" class="input_check" /><label for="activated-0">', $txt['activated'], '</label>&nbsp;&nbsp;
								<input type="checkbox" name="activated[]" value="0" id="activated-1" checked="checked" class="input_check" /><label for="activated-1">', $txt['not_activated'], '</label>
							</fieldset>
						</div>
					</div>
				</div>
			...
			foreach ($context['membergroups'] as $membergroup)
				echo '
						<tr class="windowbg2">
							...
							<td align="center">
								<input id="input_gruplar_', $membergroup['id'], '" type="checkbox" name="membergroups[1][]" value="', $membergroup['id'], '" checked="checked" class="input_check" /><label for="input_gruplar_', $membergroup['id'], '"></label>
							</td>
							<td align="center">
								', $membergroup['can_be_additional'] ? '<input id="input_gruplarr_'. $membergroup['id']. '" type="checkbox" name="membergroups[2][]" value="' . $membergroup['id'] . '" checked="checked" class="input_check" /><label for="input_gruplarr_'. $membergroup['id']. '"></label>' : '', '
							</td>
						</tr>';
			...
			echo '
						<tr class="windowbg2">
							...
							<td align="center">
								<input id="input_gruplar_hepsi" type="checkbox" onclick="invertAll(this, this.form, \'membergroups[1]\');" checked="checked" class="input_check" /><label for="input_gruplar_hepsi"></label>
							</td>
							<td align="center">
								<input id="input_gruplarr_hepsi" type="checkbox" onclick="invertAll(this, this.form, \'membergroups[2]\');" checked="checked" class="input_check" /><label for="input_gruplarr_hepsi"></label>
							</td>
						</tr>
					</tbody>
				</table>
				...
				echo '
						<tr class="windowbg2">
							...
							<td width="40" align="center">
								<input id="input_postgrup_', $postgroup['id'], '" type="checkbox" name="postgroups[]" value="', $postgroup['id'], '" checked="checked" class="input_check" /><label for="input_postgrup_', $postgroup['id'], '"></label>
							</td>
						</tr>';
			...
			echo '
						<tr class="windowbg2">
							...
							<td align="center">
								<input id="input_gruplarrr_hepsi" type="checkbox" onclick="invertAll(this, this.form, \'postgroups[]\');" checked="checked" class="input_check" /><label for="input_gruplarrr_hepsi"></label>
							</td>
						</tr>
					</tbody>
				</table>
