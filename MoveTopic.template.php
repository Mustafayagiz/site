...
function template_main()
{
	...
	echo '
						...
						<input type="checkbox" name="reset_subject" id="reset_subject" onclick="document.getElementById(\'subjectArea\').style.display = this.checked ? \'block\' : \'none\';" class="input_check" /><label for="reset_subject">', $txt['moveTopic2'], '.</label><br />
						<fieldset id="subjectArea" style="display: none;">
							...
							<input type="checkbox" name="enforce_subject" id="enforce_subject" class="input_check" /><label for="enforce_subject">', $txt['moveTopic4'], '.</label>
						</fieldset>
						<input type="checkbox" name="postRedirect" id="postRedirect" ', $context['is_approved'] ? 'checked="checked"' : '', ' onclick="', $context['is_approved'] ? '' : 'if (this.checked && !confirm(\'' . $txt['move_topic_unapproved_js'] . '\')) return false; ', 'document.getElementById(\'reasonArea\').style.display = this.checked ? \'block\' : \'none\';" class="input_check" /><label for="postRedirect">', $txt['moveTopic1'], '.</label>
